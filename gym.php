  ...
  <body>
    ...
    <section class="section__container trainer__container" id="trainer">
      ...
      <div class="trainer__grid">
        ...
        <div class="trainer__card">
          <div class="trainer__content">
            <h4>Priyanka Tripathy</h4>
            <h5>Yoga and Mindfulness</h5>
            <hr />
            <p>
              Priyanka's sessions are about physical postures and also about
    ...
    <section class="section__container price__container" id="price">
      ...
      <p class="section__description">
        Our features copes with various customers' needs, each tailored to
      ...
      <div class="price__grid">
        <div class="price__card">
          <div class="price__content">
            ...
            <p>
              Modern Equipments to enhance the perfect gym experience for individuals
        ...
        <div class="price__card">
          <div class="price__content">
            ...
            <p>
              Yoga and Zumba classes are designed to provide structure and variety to
              your workouts, ensuring you stay motivated and on track.
            </p>
            <hr />
            <h4>Key Features</h4>
            <p>Yoga- an Indian pracice</p>
            <p>Relaxing workout plan</p>
        ...
        <div class="price__card">
          <div class="price__content">
            ...
            <p>
              With this flexible timings, you'll have access to our
